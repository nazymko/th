...
public class ThRuleRecord extends UpdatableRecordImpl<ThRuleRecord> implements Record5<String, String, Integer, Integer, RuleStatus> {

    private static final long serialVersionUID = -167027482;
     ...
     */
    public ThRuleRecord(String site, String rule, Integer version, Integer id, RuleStatus status) {
        super(ThRule.TH_RULE);
     ...
     */
    @Override
    public ThRuleRecord values(String value1, String value2, Integer value3, Integer value4, RuleStatus value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);

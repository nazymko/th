...
public class TaskRun extends TableImpl<TaskRunRecord> {
	...
	private static final long serialVersionUID = 677425916;
	...
	public List<ForeignKey<TaskRunRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<TaskRunRecord, ?>>asList(Keys.TASK_RUN_IBFK_1, Keys.TASK_RUN_IBFK_3, Keys.TASK_RUN_IBFK_2, Keys.TASK_RUN_IBFK_4);
	}

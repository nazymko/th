...
public class TaskSchedule extends TableImpl<TaskScheduleRecord> {
	...
	private static final long serialVersionUID = -1292229602;
	...
	public List<ForeignKey<TaskScheduleRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<TaskScheduleRecord, ?>>asList(Keys.TASK_SCHEDULE_IBFK_1, Keys.TASK_SCHEDULE_IBFK_2);
	}

...
public class LogAttrListener implements AttrListener {
    ...
    public void process(Integer pageId, Attribute attribute, Integer runId) {
        log.debug("{} listener: {}: " + "current page '{}', attr '{}', value(20 signs) '{}'", threadName(), identifier(), attribute.getPageId(), attribute.getAttrMeaning(), attribute.getAttrValue().substring(0, Math.min(20, attribute.getAttrValue().length())));
    }

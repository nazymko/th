...
ALTER TABLE connector_rules ADD FOREIGN KEY (consumer_id) REFERENCES connector_consumer (id);
ALTER TABLE connector_rules ADD FOREIGN KEY (site_id) REFERENCES th_site (id);
